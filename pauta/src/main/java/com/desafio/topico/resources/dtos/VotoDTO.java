...
public class VotoDTO {
	...
	@NotNull(message = "É obritório informar o identificador da Topico a ser votada")
	private Long idtopico;

	@NotNull(message = "É obritório informar o identificador da Topico a ser votada")
	@NotEmpty(message = "É obritório informar o identificador da Topico a ser votada")
